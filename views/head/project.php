...
<?php require 'nav.html'; ?>
    ...
    <div class="container">
        <div class="row  mt-5">
            ...
            <h1>Add Project </h1>
            <form action="../../controllers/head/project/add_projects.php" method="POST" enctype="multipart/form-data">
                 <div class="mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col d-flex justify-content-around">
                            <form action="delete_project.php" method="POST" class="delete-form">
                                <input class="d-none" type="hidden" name="project_id" value="<?php echo $club[0]['id']; ?>">
